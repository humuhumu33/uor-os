...
import { ArrowRight, Upload, Sparkles, Layers, BookOpen, FolderOpen, LayoutGrid, Play, Download, MonitorSmartphone } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div ref={containerRef} className="pointer-events-auto w-full max-w-[580px] px-6 flex flex-col items-center">
        ...
        {/* Download CTA moved to DesktopShell top-right */}
      </div>
