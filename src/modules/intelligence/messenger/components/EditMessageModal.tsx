...
export default function EditMessageModal({ open, initialText, onSave, onClose }: Props) {
  ...
  return (
    <CSSPresence
      show={open}
      enterClass="sov-overlay-enter"
      exitClass="sov-fade-out"
      className="fixed inset-0 z-[300] flex items-center justify-center bg-black/60 backdrop-blur-sm"
      onClick={onClose}
    >
      <div
        className="w-full max-w-md mx-4 bg-slate-900/95 backdrop-blur-xl border border-white/[0.1] rounded-2xl shadow-2xl overflow-hidden sov-scale-in"
